            ...
            <h5 class="title font-weight-bold space bg-light p-3">Building / Add Building</h5>
            <?php
            ...
            ?>
            <form action="<?=base_url('Building/add_building')?>" method="post" autocomplete="off" enctype="multipart/form-data">
                <div class="row mt-5">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                       ...
                       <div class="row d-flex">
                           ...
                           <input type="checkbox"  name="rent" > 
                              <label for="vehicle1"> Rent</label><br>
                           </div>
                           <div class="col-md-4 col-4 left p-0">
                ...
                <div class="row mt-1">
                    <div class="col-md-6">
                        ...
                        <input class="form-control "type="text" required placeholder="Xyz Content...." name="note">
                    </div>
                    <div class="col-md-3">
