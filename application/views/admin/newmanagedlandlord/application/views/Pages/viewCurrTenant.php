    ...
    vertical-align: top !important;
     border-top: 0px solid #dee2e6 !important; 
      border-bottom: 1px solid #dee2e6 !important; 
            ...
            <h5 class="title font-weight-bold space bg-light p-3">Tenant / Current Tenant</h5>
            <?php
              ...
              foreach($fetch_current_tenantDetails as $row)
              {
                ...
                ?>
                  <tr>
                    ...
                    <td><a href="<?=base_url('Tenant/editCurrentTenantSection/').$row->tcurrent_id?>"  class="w-100 rounded-pill border-0 p-2 text-white font-weight-bold butn-style" currtenant">Edit</a></td>
                    <td><a href="javascript:void(0)" currtenant_id="<?=$row->tcurrent_id?>" class="w-100 rounded-pill border-0 p-2 text-white font-weight-bold butn-style1 deletecurrtenant">Delete</a></td>
                  </tr>
                <?php
