            ...
            <h5 class="title font-weight-bold space bg-light p-3">Vendor / Update Vendor</h5>
            <?php
            ...
            ?>
            <form action="<?=base_url('Vendor/updateVendorDetails')?>" method="post"  enctype="multipart/form-data">
                <div class="row mt-5">
                    <div class="col-md-6">
                ...
                <div class="row mt-1">
                    ...
                    <div class="col-md-4">
                        ...
                        <input class="form-control "type="number" value="<?=$od->mobile?>" required name="mob">
                    </div>
                </div>
                <div class="row mt-1">
                    <div class="col-md-4">
                        <label for="email">Email :</label>
                        <input class="form-control "type="text" value="<?=$od->email?>" required name="email">
                    </div>
                    <div class="col-md-4">
                        <div class="row">
                ...
                <div class="col-md-10 col-9">
                 <h6>Note*: 2 Images Mandatory In Previous Images</h6>
                 <input type="hidden" name="image_string" id="image_string" value="<?=$od->vendor_image?>" class="form-control">
                    ...
                    for($i=0; $i<count($myImages);$i++)
                    {
                      ?>
                        <li>
                            <img style="width:4em;" src="<?php echo base_url().'assets/vendor_image/'.$myImages[$i]?>" class="img-reponsive thumbnail ">
                           
                            <a href="javascript:void(0)" img_id="<?=$i?>"  img_String="<?=$od->vendor_image?>" class=" rounded-pill border-0 p-2 text-white font-weight-bold butn-style1 deleteimage">Delete</a>
                         </li>
                         <?php
