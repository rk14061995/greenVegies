    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Update Current Tenant</li>
        </ol>
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            ...
            ?>
        <form class="form-group" action="<?=base_url('Tenant/UpdateCurrentTenantDetails')?>" method="post" enctype="multipart/form-data">
              <div class="row">
                <div class="col-md-6">
              ...
              <br>
               ...
               <div class="row">
                ...
                <!-- <input class="form-control" value="<?=$od->rent_due_day?>"placeholder="Lease Period" type="number" name="lease_period"></div> -->
